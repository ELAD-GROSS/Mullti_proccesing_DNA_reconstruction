...
def declassify_reads(reads, freq, letters_amount, classifications, padding_size, paddings_hash, four_pow,
    ...
    for read in reads:
        ...
        if padding_pos_start == NO_FULL_PADDING:
            ...
            # In this code, we are storing only the read that has the maximum real data
            # either in the beginning or at the end.
            # The purpose of doing this is to reduce cycles in the graph,
            # and to decrease the number of reads in the next step.
